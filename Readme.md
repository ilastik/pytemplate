...
4. Write readable Python code:
    ...
    * If you are working with Python 2.7 (which most of us do), it might make sense to be prepared for the change to Python 3. For that, use the imports from **future**:
     ```
     from future import division, absolute_import, unicode_literals, print_function
     ``` 
